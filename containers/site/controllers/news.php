<?php
	 ...
	 */
	require('containers/site/models/paginate.php');
	require('containers/site/models/news.php');
	class NewsController extends NewsModel{
		...
		public function index(){
			...
			require('containers/site/views/news/index.php');
		}
		...
		public function view($id){
			...
			require('containers/site/views/news/view.php');
		}
		...
		public function list_all($subcategory_id){
			...
			require('containers/site/views/news/list.php');
		}
	}